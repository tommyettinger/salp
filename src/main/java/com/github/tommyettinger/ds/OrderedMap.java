...
import com.github.tommyettinger.util.GwtIncompatible;
...
public class OrderedMap<K, V> implements SortedMap<K, V>, Serializable, Cloneable {
    ...
    /*
     * Resizable array containing the hash for each key at the position that key occurs in the iteration order.
     */
    //protected long[] link;
    ...
    */
    ...
    /**
     * Makes an OrderedMap with key and value types inferred from the types of k0 and v0, and considers all
     ...
     * rest cannot be cast to the correct type of K or V, then this inserts nothing for that pair, stops adding items,
     * and returns the current items in the order they were passed.
     ...
     */
    @SuppressWarnings("unchecked")
    public static <K, V> OrderedMap<K, V> make(K k0, V v0, Object... rest)
    {
        if(rest == null)
            return make(k0, v0);
